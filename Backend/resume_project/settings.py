...
SECRET_KEY = 'django-insecure-3-1s-+0+hr71geiu3_sn3f#ye=sijyt8l#06m$%i%k_$!4@_)c'
...
INSTALLED_APPS = [ 'rest_framework', 'screening',
...
EMAIL_HOST_USER_2 = os.environ.get('EMAIL_HOST_USER_2', 'your_second_email@gmail.com')
EMAIL_HOST_PASSWORD_2 = os.environ.get('EMAIL_HOST_PASSWORD_2', 'your_second_app_password')
